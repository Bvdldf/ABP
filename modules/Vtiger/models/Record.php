...
class Vtiger_Record_Model extends Vtiger_Base_Model {
    ...
    function getAbsent(){
            ...
            $query = 'select cer.relcrmid as contactid from vtiger_lessons l inner join vtiger_crmentityrel cer on cer.crmid=l.lessonsid inner join vtiger_contactdetails cd on cd.contactid=cer.relcrmid where lessonsid=?';
