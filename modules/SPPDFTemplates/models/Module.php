...
class SPPDFTemplates_Module_Model extends Vtiger_Module_Model {
    ...
    public function getModulesList() {
        ...
        $sql = "SELECT name FROM vtiger_tab WHERE name IN ('SalesOrder', 'Invoice', 'Quotes', 'HelpDesk', 'Act', 'Consignment', 'PurchaseOrder', 'Potentials', 'SPPayments', 'Orders', 'Protocols', 'Courses') ORDER BY name ASC";
        $result = $db->query($sql);
